    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom v-if="skuImageList.length>0" :imgUrl="skuImageList[currentImageIndex].imgUrl" :bigImgUrl="skuImageList[currentImageIndex].imgUrl" />
          <!-- 小图列表 -->
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr,index) in spuSaleAttrList" :key="attr.id">
                ...
                <dd changepirce="0" :class="{active:spuVal.isChecked==='1'}" v-for="(spuVal,index) in attr.spuSaleAttrValueList" :key="spuVal.id" @click="setChecked(spuVal,attr.spuSaleAttrValueList)">{{spuVal.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <!--数量的增加和减少的操作-->
